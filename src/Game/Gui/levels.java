...
public class levels {
    ...
    public  void drawlevels(GL gl ) {
        ...
        animEventListener.drawSprite(gl, x, y+30, indexplay[3],20 , 10);
        animEventListener.drawSprite(gl, x, y+18, indexplay[0],20 , 10);
        animEventListener.drawSprite(gl, x, y+6, indexplay[1],20 , 10);
